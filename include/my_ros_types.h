...
#define MSG_LIST(BTYPE, CTYPE, TTYPE, FIELD, ARRAY, SEQUENCE) \
    ...
    CTYPE(ros_TF2Error, \
        "tf2_msgs::msg::dds_::TF2Error", \
        "db2485e7d6a0ec75bf087e058ee45df682acc3a621ca7780503d10aac141809a", \
        FIELD(uint8_t, error) \
        FIELD(rstring, error_string) \
    ) \
    CTYPE(ros_TFMessage, \
        "tf2_msgs::msg::dds_::TFMessage", \
        "e369d0f05a23ae52508854b66f6aa0437f3449d652e8cbf22d5abe85d020f087", \
        SEQUENCE(ros_TransformStamped, transforms) \
    ) \
...
#define SRV_LIST(SRV, REQUEST, REPLY, FIELD, ARRAY, SEQUENCE) \
    ...
    SRV(srv_FrameGraph, \
        "tf2_msgs::srv::dds_::FrameGraph", \
        "4cc565da6b64726d0b0be1ce20f3a3a695679b841a79abfca2fcdc94f562b08d", \
        REQUEST( \
            FIELD(uint8_t, empty) \
        ), \
        REPLY( \
            FIELD(rstring, frame_yaml) \
        ) \
    )
